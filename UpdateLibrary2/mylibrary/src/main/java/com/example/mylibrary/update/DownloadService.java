...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        com.example.mylibrary.update.NotificationHelper notificationHelper = new com.example.mylibrary.update.NotificationHelper(this);
        String urlStr = intent.getStringExtra("url");
        InputStream in = null;
        FileOutputStream out = null;
        try {
            // Duermo 5 segundos simulando la descarga.
//            Thread.sleep(5000);
//            Toast.makeText(this, "FIN DESCARFGA", Toast.LENGTH_SHORT).show();
            ...
            File dir = com.example.mylibrary.update.StorageUtils.getCacheDirectory(this);
            ...
            com.example.mylibrary.update.ApkUtils.installAPk(this, apkFile);
