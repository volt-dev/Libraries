...
public class ApkUtils {
    ...
    private static Uri getApkUri(File apkFile) {
        Log.d(com.example.library.Constants.TAG, apkFile.toString());
        // Si no hay un conjunto de permisos de escritura de SDCard, o no hay SDCard,
        // el archivo apk se guarda en la memoria, debe otorgar permiso para instalar
        try {
        ...
        Log.d(com.example.library.Constants.TAG, uri.toString());
        return uri;
    }
